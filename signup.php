...
<html>
  ...
  <body>
    ...
    <div class="max">
      <p>Welcome to Devolver Digital Gaming Zone.....<br>Quickely SignUp For Execting Games</p>
    </div><br>
    <form class="" action="index.html" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" name="username" value=""placeholder="enter a username.."><br>
      </div>
      <div class="form-group">
        <label for="email">Enter Your Email:</label><br>
        <input type="email" name="email" value=""placeholder="enter a valid email.."><br>
      </div>
      <div class="form-group">
        <label for="mobile">Mobile No:</label><br>
        <input type="number" name="mobile" value=""placeholder="enter your mobile number.."><br>
      </div>
      <div class="form-group">
